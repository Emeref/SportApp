...
object TextsMobilePL : MobileTexts {
    ...
    override val ACTIVITY_EXPORT_DIALOG_TITLE = "Eksportuj aktywność"
    override val STR_STRAVA = "Strava"
    override val STR_HEALTH_CONNECT = "Health Connect"
    override val ACTIVITY_ALREADY_SYNCED = "Zsynchronizowano"
    override val ACTIVITY_EXPORT = "Eksportuj"
    ...
    // Support System
    override val SUPPORT_TITLE = "Wesprzyj Autora"
    override val SUPPORT_DISCLAIMER = "Wszystkie funkcje aplikacji są darmowe. Wybór poziomu to dobrowolne wsparcie autora. Zmiana ikony jest jedynym benefitem cyfrowym."
