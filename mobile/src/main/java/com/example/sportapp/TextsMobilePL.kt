...
object TextsMobilePL : MobileTexts {
    ...
    override val NAV_SETTINGS = "Opcje"

    // Home Screen
    override val HOME_TITLE = "SportApp"
    override val HOME_NO_WIDGETS = "Nie masz wybranego żadnego widgeta"
    ...
    override val HOME_LOGO_DESC = "Logo Apki"
    override val HOME_SECRET_TITLE = "Super, że klikasz, ale tu nic nie ma"
    ...
    override val SETTINGS_HEALTH_DATA = "Dane zdrowotne i tętno"
    override val SETTINGS_HEALTH_DATA_DESC = "Wiek, waga, HR Max i strefy"
    override val SETTINGS_DEFINITIONS = "Definicja aktywności"
    override val SETTINGS_DEFINITIONS_DESC = "Zarządzaj listą i czujnikami sportów"
    override val SETTINGS_WIDGETS_HOME = "Widgety na stronie głównej"
    override val SETTINGS_WIDGETS_HOME_TITLE = "Widok ekranu głównego"
    override val SETTINGS_WIDGETS_HOME_DESC = "Wybierz i ustaw kolejność"
    override val SETTINGS_WIDGETS_WATCH = "Statystyki na zegarku"
    override val SETTINGS_WIDGETS_WATCH_TITLE = "Pola statystyk"
    override val SETTINGS_WIDGETS_WATCH_DESC = "Wybierz i ustaw kolejność pól na zegarku"
    ...
    override val SETTINGS_PERIOD_HOME_DESC = "Za jaki okres pokazujemy widgety?"
    override val SETTINGS_PERIOD_WATCH_DESC = "Z jakiego okresu statystyki?"
    ...
    override val HEALTH_MAX_HR = "Tętno maksymalne (HR Max)"
    ...
    override val ACTIVITY_DELETE_CONFIRM = "Czy na pewno chcesz trwale usunąć zaznaczone aktywności z bazy danych?"
    ...
    override val DETAIL_INTERVALS = "Odcinki"
    override fun detailLapsWithDistance(distance: String) = "Odcinki ($distance)"
    override fun detailLapsCount(count: Int) = "Liczba odcinków: $count"
    ...
    override val DETAIL_LAP_MAX_SPEED = "Max Prędkość"
    override val DETAIL_LAP_AVG_HR = "Śr. HR"
    ...
    override val DETAIL_PREDOMINANT_EFFECT = "Przeważający efekt treningu"
    ...
    override fun chartDistanceGps(km: Boolean) = if (km) "Dystans (GPS) w kilometrach" else "Dystans (GPS) w metrach"
    override fun chartDistanceSteps(km: Boolean) = if (km) "Dystans (kroki) w kilometrach" else "Dystans (kroki) w metrach"
    override val CHART_STEPS = "Kroki"

    // Definitions
    override val DEF_TITLE = "Definicje treningów"
    ...
    override val DEF_SENSORS_DESC = "Zarządzaj listą i czujnikami sportów"
    ...
    override val DEF_AUTO_LAP_LABEL = "Automatyczny odcinek (metry, opcjonalnie)"
    override val DEF_WIDGET_IN_ACTIVITY = "Widget w aktywności"
    override val DEF_VISIBILITY = "Widoczność"
    override val DEF_RECORD = "Zapis"
