...
object TextsMobileEN : MobileTexts {
    ...
    override val NAV_STATS = "Statistics"
    ...
    override val HOME_SECRET_TITLE = "Nice that you're clicking, but there's nothing here"
    override val HOME_CLOSE = "Close"
    override val HOME_START_LIVE = "Start Live Tracking"
    override val HOME_ACTIVE_WORKOUT = "Activity in progress"
    override val HOME_RESUME_TRACKING = "Track activity"
    ...
    override fun homeResultsMonth(): String {
        ...
        return "Results for $monthName:"
    }
    override fun homeResultsYear() = "Yearly results:"
    override fun homeResultsCustom(days: Int) = if (days == 1) "Results from the last day:" else "Results from the last $days days:"
    ...
    override val SETTINGS_HEALTH_DATA_DESC = "Age, weight, HR Max and zones"
    ...
    override val SETTINGS_WIDGETS_HOME_TITLE = "Start view"
    override val SETTINGS_WIDGETS_HOME_DESC = "Select and set order"
    override val SETTINGS_WIDGETS_WATCH = "Watch statistics"
    ...
    override val SETTINGS_PERIOD_HOME_DESC = "Which period to show widgets for?"
    ...
    override val SETTINGS_CUSTOM_DAYS_DESC = "Number of days for 'Other' period"
    override val SETTINGS_WATCH_STATS_DAYS_DESC = "Number of stats days on watch"
    override val SETTINGS_INTEGRATION = "Integration"
    override val SETTINGS_SYNC = "Synchronization"
    ...
    override val HC_SYNC_CONFIRM_TITLE = "Data sync"
    override val HC_SYNC_CONFIRM_DESC = "Do you want to update your profile with data found in Health Connect?"
    override val HC_SYNC_SUCCESS = "Sync successful"
    override val HC_SYNC_ERROR = "Sync error"
    ...
    override val HC_IMPORT_EMPTY = "No workouts found in Health Connect from the last week."
    ...
    override val HC_EXPORT_SUCCESS = "Export completed successfully"
    override val HC_EXPORT_ERROR = "Export error: "
    override val HC_EXPORT_PERMISSION_DENIED = "No write permissions for Health Connect"
    ...
    override val HC_PERMISSIONS_DIALOG_DESC = "Write permissions are required to export workouts to Health Connect. You can grant them in system settings."
    ...
    override val HEALTH_MAX_HR_DESC = "Maximum heart rate"
    ...
    override val ACTIVITY_DURATION = "Duration"
    ...
    override val ACTIVITY_IMPORT_SELECT_DESC = "Select workout type for the imported GPX file:"
    ...
    override val ACTIVITY_EXPORT_SAE_DESC = "SAE format (.sae) allows for a full backup of all workout data, including indoor workouts (without GPS)."
    override val ACTIVITY_EXPORT_INCOMPATIBLE_GPX = "Some selected activities do not have GPS data and cannot be exported to GPX format."
    ...
    override fun detailLapsCount(count: Int) = "Number of laps: $count"
    ...
    override val DETAIL_TRAINING_EFFECT_DESC = "Dominant training effect"
    ...
    override val DETAIL_PREDOMINANT_EFFECT = "Dominant training effect"

    // Stats
    override val STATS_TITLE = "General statistics"
    ...
    override val STATS_SECTION_CHARTS = "Section: Trend charts"
    ...
    override val DEF_NAME_HINT = "E.g., Treadmill"
    ...
    override val DEF_STAIR_CLIMBING_MACHINE = "Stair machine"
    ...
    override val DEF_SWIMMING_POOL = "Pool swimming"
    override val DEF_SWIMMING_OPEN_WATER = "Open water swimming"
    ...
    override val DEF_ICE_SKATING = "Figure skating"
    ...
    // Heart Rate Math
    override val HR_NO_DATA = "No heart rate data"
    ...
    override val VM_EXPORT_ZIPPING = "Zipping files..."
    ...
    override val GPX_WARN_HR = "File contains heart rate data, but the selected activity doesn't support it."
    override val GPX_WARN_ELE = "File contains elevation data, but the selected activity doesn't support it."
    override val GPX_WARN_CADENCE = "File contains cadence data, but the selected activity doesn't support it."
    ...
    override val WIDGET_AVG_BPM = "Average heart rate"
    ...
    override val WIDGET_MAX_BPM = "Maximum heart rate"
    ...
    override val WIDGET_WATCH_ASCENT = "Elevation gain"
    override val WIDGET_WATCH_DESCENT = "Elevation loss"
    ...
    override val TRIM_CONFIRM_DESC = "Are you sure you want to delete data outside the selected range? This data will be permanently removed."
    ...
    override val TRIM_PREVIEW_TITLE = "New stats preview"
    ...
    override val STRAVA_CONNECT = "Connect Strava account"
    override val STRAVA_DISCONNECT = "Disconnect Strava account"
    override val STRAVA_CONNECTED = "Connected with Strava"
    override val STRAVA_NOT_CONNECTED = "Not connected"
    override val STRAVA_SYNC_NOW = "Sync now"
    override val STRAVA_SYNC_SUCCESS = "Workout has been sent!"
    override val STRAVA_SYNC_FAILED = "Upload error"
    ...
    override val SETTINGS_STRAVA_AUTO_EXPORT_DESC = "Automatically send new workouts to Strava"
    ...
    override val LIVE_TRACKING_FINISHED_TITLE = "Activity finished"
    override val LIVE_TRACKING_FINISHED_DESC = "Activity completed successfully"
    override val LIVE_TRACKING_BTN_FINISH = "Finish"
    override val LIVE_TRACKING_BTN_VIEW_MAP = "View map"
    override val LIVE_TRACKING_PAUSED = "Paused"

    // Errors
    override val ERROR_WEARABLE_NOT_AVAILABLE = "Wearable services are unavailable on this device"
    override val ERROR_NO_WATCH_CONNECTED = "No connected watch found"
    ...
    override val SUPPORT_DISCLAIMER = "All app features are free. Level selection is a voluntary support of the author. Changing the icon is the only digital benefit."
