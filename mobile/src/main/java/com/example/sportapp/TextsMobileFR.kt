...
object TextsMobileFR : MobileTexts {
    ...
    override val HOME_SECRET_TITLE = "C'est sympa de cliquer, mais il n'y a rien ici"
    override val HOME_CLOSE = "Fermer"
    override val HOME_START_LIVE = "Démarrer le Live Tracking"
    override val HOME_ACTIVE_WORKOUT = "Activité en cours"
    override val HOME_RESUME_TRACKING = "Suivre l'activité"
    ...
    override fun homeResultsMonth(): String {
        val monthName = Calendar.getInstance().getDisplayName(Calendar.MONTH, Calendar.LONG, Locale("fr", "FR"))
    ...
    override val SETTINGS_WIDGETS_HOME_TITLE = "Vue de démarrage"
    override val SETTINGS_WIDGETS_HOME_DESC = "Choisir et organiser l'ordre"
    override val SETTINGS_WIDGETS_WATCH = "Stats sur la montre"
    override val SETTINGS_WIDGETS_WATCH_TITLE = "Champs de statistiques"
    override val SETTINGS_WIDGETS_WATCH_DESC = "Choisir et organiser l'ordre sur la montre"
    ...
    override val SETTINGS_PERIOD_WATCH_DESC = "Statistiques de quelle période ?"
    override val SETTINGS_CUSTOM_DAYS_LABEL = "Nombre de jours"
    override val SETTINGS_WATCH_STATS_DAYS_LABEL = "Afficher les stats sur combien de jours ?"
    override val SETTINGS_CUSTOM_DAYS_DESC = "Nombre de jours pour la période 'Autre'"
    override val SETTINGS_WATCH_STATS_DAYS_DESC = "Nombre de jours de stats sur la montre"
    ...
    override val SETTINGS_GOOGLE_DRIVE_DESC = "Sauvegarder l'historique et résumés (Bientôt)"
    ...
    override val HC_SYNC_WORKOUTS = "Importer entraînements de Health Connect"
    override val HC_SYNC_CONFIRM_TITLE = "Synchronisation des données"
    override val HC_SYNC_CONFIRM_DESC = "Voulez-vous mettre à jour votre profil avec les données de Health Connect ?"
    ...
    override val HC_IMPORT_SELECT_FIELDS_TITLE = "Choisir les données à importer"
    ...
    override val HC_IMPORT_TITLE = "Importer entraînements"
    override val HC_IMPORT_ALREADY_IMPORTED = "Déjà importé"
    override val HC_IMPORT_EMPTY = "Aucun entraînement trouvé dans Health Connect cette dernière semaine."
    override val HC_IMPORT_CONFIRM_DESC_PLURAL = "Voulez-vous vraiment importer les entraînements sélectionnés ?"
    override val HC_IMPORT_SELECT_ALL = "Tout sélectionner"
    override fun hcImportSelected(count: Int) = "Importer sélectionnés ($count)"
    ...
    override val HC_EXPORT_PERMISSION_DENIED = "Permission d'écriture refusée dans Health Connect"
    ...
    override val SYNC_LAST_HEALTH = "Dernière synchro santé"
    override val SYNC_LAST_WORKOUT = "Dernière synchro entraînement"
    ...
    override val SYNC_CONFLICT_NEWER = "Le plus récent l'emporte"
    override val SYNC_CONFLICT_LOCAL = "Local l'emporte"
    override val SYNC_CONFLICT_HC = "Health Connect l'emporte"

    // Health Connect Permissions Dialog
    override val HC_PERMISSIONS_DIALOG_TITLE = "Permissions requises"
    override val HC_PERMISSIONS_DIALOG_DESC = "Les permissions d'écriture sont nécessaires pour exporter les entraînements vers Health Connect. Vous pouvez les accorder dans les paramètres système."
    ...
    override val HEALTH_RESTING_HR = "Fréquence cardiaque au repos"
    override val HEALTH_MAX_HR = "Fréquence cardiaque maximale"
    override val HEALTH_MAX_HR_DESC = "Fréquence cardiaque maximale"
    ...
    override val ACTIVITY_DELETE_CONFIRM = "Voulez-vous vraiment supprimer définitivement les activités sélectionnées de la base de données ?"
    ...
    override val ACTIVITY_CHART_SETTINGS = "Paramètres des graphiques"
    ...
    override val ACTIVITY_EXPORT_DIALOG_TITLE = "Exporter l'activité"
    override val STR_STRAVA = "Strava"
    override val STR_HEALTH_CONNECT = "Health Connect"
    override val ACTIVITY_ALREADY_SYNCED = "Synchronisé"
    override val ACTIVITY_EXPORT = "Exporter"
    ...
    override val ACTIVITY_ALL = "Toutes"
    override val ACTIVITY_NONE = "Aucune"
    ...
    override val ACTIVITY_EXPORT_SAE_DESC = "Le format SAE (.sae) permet une sauvegarde complète de toutes les données d'entraînement, y compris l'intérieur (sans GPS)."
    override val ACTIVITY_EXPORT_INCOMPATIBLE_GPX = "Certaines activités sélectionnées n'ont pas de données GPS et ne peuvent pas être exportées au format GPX."
    ...
    override val DETAIL_TRAINING_EFFECT_DESC = "Effet d'entraînement dominant"
    override val DETAIL_LAP_NR = "N°"
    override val DETAIL_LAP_TIME = "Temps"
    ...
    override val DETAIL_LAP_ASCENT_DESCENT = "Haut/Bas"
    ...
    override val DETAIL_PREDOMINANT_EFFECT = "Effet d'entraînement dominant"
    ...
    override val DEF_SELECT_ICON = "Choisir l'icône"
    ...
    override val DEF_NAME_HINT = "Ex. Tapis de course"
    ...
    override val DEF_ROAD_BIKING = "Cyclisme sur route"
    ...
    override val DEF_PADDLE_BOARDING = "Paddle (SUP)"
    ...
    override val DEF_ICE_SKATING = "Patinage artistique"

    override val DEF_GYM = "Salle de sport"
    ...
    // Heart Rate Math
    override val HR_NO_DATA = "Pas de données de FC"
    ...
    override val HR_EFFECT_Z2 = "Brûle-graisses efficace"
    override val HR_EFFECT_Z3 = "Amélioration de l'endurance aérobie"
    ...
    override val VM_EXPORT_ZIPPING = "Compression ZIP..."
    ...
    override val VM_IMPORT_DUPLICATE_WARNING_DESC = "Voulez-vous quand même continuer ?"
    ...
    // Gpx Importer
    override val GPX_NO_POINTS = "Le fichier GPX ne contient pas de points de trajet."
    override val GPX_WARN_HR = "Le fichier contient des données de FC, mais l'activité choisie ne les supporte pas."
    override val GPX_WARN_ELE = "Le fichier contient des données d'altitude, mais l'activité choisie ne les supporte pas."
    override val GPX_WARN_CADENCE = "Le fichier contient des données de cadence, mais l'activité choisie ne les supporte pas."
    ...
    override val WIDGET_MAX_ELEVATION_GAIN = "Gain d'élévation max"
    override val WIDGET_MAX_DISTANCE = "Plus grande distance"
    override val WIDGET_MAX_DURATION = "Plus longue durée"
    override val WIDGET_MAX_CALORIES = "Plus de calories"
    override val WIDGET_MAX_AVG_CADENCE = "Cadence moy. la plus haute"
    override val WIDGET_MAX_AVG_SPEED = "Vitesse moy. la plus haute"
    ...
    override val WIDGET_MAX_CALORIES_MIN = "Brûlage calorique max"
    ...
    override val WIDGET_TOTAL_ASCENT = "Somme des montées"
    override val WIDGET_TOTAL_DESCENT = "Somme des descentes"
    override val WIDGET_AVG_STEP_LENGTH = "Longueur de foulée calculée"
    ...
    override val WIDGET_WATCH_ASCENT = "Dénivelé positif"
    override val WIDGET_WATCH_DESCENT = "Dénivelé négatif"
    ...
    override val SENSOR_TOTAL_ASCENT = "Somme des montées"
    override val SENSOR_TOTAL_DESCENT = "Somme des descentes"
    override val SENSOR_PRESSURE = "Pression atm."
    override val SENSOR_MAP = "Données de localisation"
    override val SENSOR_AVG_STEP_LENGTH = "Longueur de foulée moyenne"

    // Trim Screen
    override val TRIM_TITLE = "Modifier l'entraînement (Rognage)"
    override val TRIM_CONFIRM_TITLE = "Confirmer le rognage"
    override val TRIM_CONFIRM_DESC = "Voulez-vous vraiment supprimer les données en dehors de la plage sélectionnée ? Ces données seront définitivement effacées."
    ...
    override val COMPARE_HIGHER_IS_BETTER = "Un score plus haut est meilleur"
    ...
    override val STRAVA_CONNECT = "Connecter le compte Strava"
    override val STRAVA_DISCONNECT = "Déconnecter le compte Strava"
    ...
    override val STRAVA_SYNC_FAILED = "Erreur d'envoi"
    override val STRAVA_SYNCING = "Envoi..."
    override val STRAVA_AUTH_ERROR = "Erreur d'autorisation"
    override val SETTINGS_STRAVA_AUTO_EXPORT = "Exportation automatique"
    override val SETTINGS_STRAVA_AUTO_EXPORT_DESC = "Envoyer automatiquement les nouveaux entraînements vers Strava"
    override val STRAVA_SYNC_LOG = "Historique de synchronisation"
    override val STRAVA_SYNC_LOG_EMPTY = "Aucun historique de synchronisation"

    // Live Tracking
    override val LIVE_TRACKING_TITLE = "Live Tracking"
    override val LIVE_TRACKING_SELECT_ACTIVITY = "Choisir l'activité"
    ...
    override val LIVE_TRACKING_WAITING_FOR_WATCH = "Attente du signal de la montre..."
    override val LIVE_TRACKING_FINISHED_TITLE = "Activité terminée"
    override val LIVE_TRACKING_FINISHED_DESC = "Activité terminée avec succès"
    ...
    // Errors
    override val ERROR_WEARABLE_NOT_AVAILABLE = "Services Wearable indisponibles sur cet appareil"
    override val ERROR_NO_WATCH_CONNECTED = "Aucune montre connectée trouvée"
    ...
    // Support System
    override val SUPPORT_TITLE = "Soutenir l'auteur"
    override val SUPPORT_DISCLAIMER = "Toutes les fonctions de l'application sont gratuites. Le choix du niveau est un soutien volontaire. Le changement d'icône est le seul avantage numérique."
    override val SUPPORT_LIFETIME_BUY = "À vie"
    override val SUPPORT_MONTHLY_SUB = "Mensuel"
    override val SUPPORT_ICON_CHANGE_NOTICE = "Le changement d'icône peut prendre quelques secondes ou nécessiter un redémarrage du launcher."
}