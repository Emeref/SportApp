...
object TextsMobileFR : MobileTexts {
    ...
    override val DEF_SWIMMING_OPEN_WATER = "Natation (eaux libres)"
    override val DEF_KAYAKING = "Kayak"
    override val DEF_PADDLE_BOARDING = "Paddle board"
    ...
    override val HR_EFFECT_Z3 = "Amélioration capacité aérobie"
    ...
    override val GPX_WARN_ELE = "Le fichier contient des données d'altitude, mais l'activité choisie ne les supporta pas."
    ...
    override val WIDGET_MAX_SPEED = "Vitesse maximale"
    override val WIDGET_MAX_ALTITUDE = "Altitude maximale"
    ...
    override val WIDGET_MAX_CALORIES_MIN = "Vitesse max de combustion"
    ...
    override val WIDGET_MAX_ALTITUDE_DESC = "Altitude maximale"
    override val WIDGET_TOTAL_ASCENT = "Cumul dénivelé positif"
    override val WIDGET_TOTAL_DESCENT = "Cumul dénivelé négatif"
    ...
    override val SENSOR_CALORIES_SUM = "Cumul calories"
    ...
    // Trim Screen
    override val TRIM_TITLE = "Modifier l'entraînement (Rogner)"
