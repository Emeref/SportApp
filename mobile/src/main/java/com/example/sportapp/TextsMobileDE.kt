...
object TextsMobileDE : MobileTexts {
    ...
    override val WIDGET_AVG_SPEED_GPS = "Durchschn. Geschwindigkeit (GPS)"
    override val WIDGET_AVG_SPEED_STEPS = "Durchschn. Geschwindigkeit (Schritte)"
    ...
    override val SETTINGS_STRAVA_AUTO_EXPORT_DESC = "Neue Workouts automatisch nach Strava exportieren"
    ...
    override val TRIM_CONFIRM_DESC = "Sind Sie sicher, dass Sie Daten außerhalb des ausgewählten Bereichs löschen möchten? Diese Daten werden dauerhaft entfernt."
    ...
    override val UNIT_STEP_MIN = "Schritte/Min"
