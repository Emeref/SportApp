...
object TextsMobileDE : MobileTexts {
    ...
    override val HOME_WORKOUT_DETAILS = "Trainingseinzelheiten"
    ...
    override val HOME_ACTIVE_WORKOUT = "Aktivität läuft"
    override val HOME_RESUME_TRACKING = "Aktivität verfolgen"

    override fun homeResultsToday() = "Heutige Ergebnisse:"
    override fun homeResultsWeek() = "Ergebnisse der Woche:"
    override fun homeResultsMonth(): String {
        val monthName = Calendar.getInstance().getDisplayName(Calendar.MONTH, Calendar.LONG, Locale("de", "DE"))
        return "Ergebnisse aus $monthName:"
    }
    override fun homeResultsYear() = "Ergebnisse aus diesem Jahr:"
    ...
    override val SETTINGS_HEALTH_DATA_DESC = "Alter, Gewicht, Max. HF und Zonen"
    ...
    override val SETTINGS_WIDGETS_HOME_DESC = "Wählen und Reihenfolge festlegen"
    override val SETTINGS_WIDGETS_WATCH = "Statistiken auf der Uhr"
    override val SETTINGS_WIDGETS_WATCH_TITLE = "Statistikfelder"
    override val SETTINGS_WIDGETS_WATCH_DESC = "Wählen und Reihenfolge auf der Uhr festlegen"
    ...
    override val SETTINGS_WATCH_STATS_DAYS_LABEL = "Statistiken für wie viele Tage anzeigen?"
    override val SETTINGS_CUSTOM_DAYS_DESC = "Anzahl der Tage für Zeitraum 'Andere'"
    override val SETTINGS_WATCH_STATS_DAYS_DESC = "Anzahl der Statisktiktage auf der Uhr"
    ...
    override val SETTINGS_STRAVA_DESC = "Synchronisiere deine Trainings mit Strava"
    ...
    override val HC_SYNC_WORKOUTS = "Trainings von Health Connect importieren"
    override val HC_SYNC_CONFIRM_TITLE = "Datensynchronisation"
    override val HC_SYNC_CONFIRM_DESC = "Möchtest du dein Profil mit den in Health Connect gefundenen Daten aktualisieren?"
    ...
    override val HC_IMPORT_SELECT_FIELDS_TITLE = "Zu importierende Daten wählen"
    ...
    override val HC_IMPORT_TITLE = "Trainings importieren"
    override val HC_IMPORT_ALREADY_IMPORTED = "Bereits importiert"
    override val HC_IMPORT_EMPTY = "Keine Trainings in Health Connect aus der letzten Woche gefunden."
    override val HC_IMPORT_CONFIRM_DESC_PLURAL = "Möchtest du die ausgewählten Trainings wirklich importieren?"
    override val HC_IMPORT_SELECT_ALL = "Alle auswählen"
    override fun hcImportSelected(count: Int) = "Ausgewählte importieren ($count)"
    override fun hcImportConfirmDesc(count: Int) = "Möchtest du $count Trainings importieren?"
    override fun hcImportProgress(current: Int, total: Int) = "Importiere $current/$total Trainings..."

    // Stage 5 - Export
    override val HC_EXPORT_TO = "Nach Health Connect exportieren"
    override val HC_EXPORTED_ON = "Mit Health Connect synchronisiert"
    override val HC_EXPORT_SUCCESS = "Export erfolgreich abgeschlossen"
    override val HC_EXPORT_ERROR = "Exportfehler: "
    override val HC_EXPORT_PERMISSION_DENIED = "Keine Schreibberechtigung für Health Connect"
    override val SETTINGS_HC_AUTO_EXPORT = "Automatischer Export"
    override val SETTINGS_HC_AUTO_EXPORT_DESC = "Neue Trainings automatisch nach Health Connect exportieren"

    // Stage 6 - Sync Status
    override val SYNC_STATUS_TITLE = "HC Synchronisationsstatus"
    override val SYNC_LAST_HEALTH = "Letzte Gesundheitssynchronisation"
    override val SYNC_LAST_WORKOUT = "Letzte Trainingssynchronisation"
    override val SYNC_UNSYNCED_COUNT = "Nicht synchronisierte Datensätze"
    override val SYNC_NOW = "Jetzt synchronisieren"
    override val SYNC_HISTORY_TITLE = "Synchronisationsverlauf"
    override val SYNC_TYPE_IMPORT = "Import"
    override val SYNC_TYPE_EXPORT = "Export"
    override val SYNC_NEVER = "Nie"
    override val SYNC_CONFLICT_POLICY = "Konfliktrichtlinie"
    override val SYNC_CONFLICT_NEWER = "Neuerer gewinnt"
    override val SYNC_CONFLICT_LOCAL = "Lokale gewinnen"
    ...
    override val HC_PERMISSIONS_DIALOG_DESC = "Schreibberechtigungen sind erforderlich, um Trainings nach Health Connect zu exportieren. Du kannst diese in den Systemeinstellungen erteilen."
    ...
    override val HEALTH_MAX_HR_DESC = "Maximalpuls"
    ...
    override val ACTIVITY_DELETE_CONFIRM = "Möchtest du die ausgewählten Aktivitäten wirklich dauerhaft aus der Datenbank löschen?"
    ...
    override val ACTIVITY_DURATION = "Dauer"
    ...
    override val ACTIVITY_IMPORT_SELECT_DESC = "Wähle den Trainingstyp für die importierte GPX-Datei:"
    ...
    override val ACTIVITY_EXPORT_DIALOG_TITLE = "Aktivität exportieren"
    override val STR_STRAVA = "Strava"
    override val STR_HEALTH_CONNECT = "Health Connect"
    override val ACTIVITY_ALREADY_SYNCED = "Synchronisiert"
    override val ACTIVITY_EXPORT = "Exportieren"
    ...
    override val ACTIVITY_NONE = "Keine"

    // New Export/Import SAE
    override val ACTIVITY_EXPORT_SAE = "SAE exportieren"
    override val ACTIVITY_IMPORT_SAE = "SAE importieren"
    override val ACTIVITY_EXPORT_FORMAT_SELECT = "Exportformat wählen"
    override val ACTIVITY_EXPORT_SAE_DESC = "Das SAE-Format (.sae) ermöglicht ein vollständiges Backup aller Trainingsdaten, einschließlich Indoor-Trainings (ohne GPS)."
    override val ACTIVITY_EXPORT_INCOMPATIBLE_GPX = "Einige ausgewählte Aktivitäten enthalten keine GPS-Daten und können nicht in das GPX-Format exportiert werden."
    ...
    override val DETAIL_HEART_RATE = "Puls (bpm)"
    override val DETAIL_HR_ZONES = "Herzfrequenzzonen"
    override val DETAIL_TRAINING_EFFECT = "Trainingseffekt"
    override val DETAIL_TRAINING_EFFECT_DESC = "Dominanter Trainingseffekt"
    ...
    override val DETAIL_LAP_AVG_HR = "Durchschn. Puls"
    override val DETAIL_LAP_MAX_HR = "Max. Puls"
    ...
    override val DETAIL_EXPAND = "Ausklappen"
    override val DETAIL_COLLAPSE = "Einklappen"
    override val DETAIL_PREDOMINANT_EFFECT = "Dominanter Trainingseffekt"

    // Stats
    override val STATS_TITLE = "Allgemeine Statistiken"
    override val STATS_CHARTS = "Diagramme"
    override val STATS_WIDGETS = "Widgets"
    override val STATS_NO_DATA = "Keine Daten zum Anzeigen von Diagrammen vorhanden."
    ...
    override val STATS_NO_WIDGETS = "Keine aktiven Widgets. Aktiviere sie in den Optionen."
    ...
    // Definitions
    override val DEF_TITLE = "Trainingsdefinitionen"
    ...
    override fun defDeleteConfirm(name: String) = "Möchtest du die Aktivität '$name' wirklich löschen?"
    ...
    override val DEF_NAME_HINT = "Z.B. Laufband"
    override val DEF_AUTO_LAP_LABEL = "Automatische Runde (Meter, optional)"
    override val DEF_WIDGET_IN_ACTIVITY = "Widget in Aktivität"
    override val DEF_VISIBILITY = "Sichtbarkeit"
    override val DEF_RECORD = "Aufnehmen"
    ...
    override val DEF_SPEED_WALKING = "Schnelles Gehen"
    override val DEF_RUNNING = "Laufen"
    override val DEF_TREADMILL_RUNNING = "Laufen auf dem Laufband"
    override val DEF_STAIR_CLIMBING = "Treppensteigen"
    override val DEF_STAIR_CLIMBING_MACHINE = "Stepper"
    override val DEF_CYCLING = "Radfahren"
    override val DEF_CYCLING_STATIONARY = "Heimtrainer"
    override val DEF_MOUNTAIN_BIKING = "Mountainbiken"
    override val DEF_ROAD_BIKING = "Rennradfahren"
    override val DEF_HIKING = "Wandern"
    override val DEF_ROCK_CLIMBING = "Felsklettern"
    override val DEF_BOULDERING = "Bouldern"
    override val DEF_HIIT = "HIIT"
    override val DEF_ELLIPTICAL = "Crosstrainer"
    override val DEF_ROWING_MACHINE = "Rudergerät"
    ...
    override val DEF_DANCING = "Tanzen"
    override val DEF_SWIMMING = "Schwimmen"
    override val DEF_SWIMMING_POOL = "Schwimmen (Becken)"
    override val DEF_SWIMMING_OPEN_WATER = "Schwimmen (Freiwasser)"
    override val DEF_KAYAKING = "Kajakfahren"
    override val DEF_PADDLE_BOARDING = "Stand Up Paddling (SUP)"
    ...
    override val DEF_ICE_SKATING = "Eiskunstlauf"
    ...
    // Heart Rate Math
    override val HR_NO_DATA = "Keine Pulsdaten"
    override val HR_TOO_LITTLE_DATA = "Zu wenig Daten"
    override val HR_BELOW_ZONES = "Puls unter den Zonen"
    override val HR_EFFECT_Z0 = "Niedrige Intensität / Aufwärmen"
    override val HR_EFFECT_Z1 = "Aerobe Basis und Regeneration"
    ...
    override val ZONE_Z4 = "Schwer"
    override val ZONE_Z5 = "Maximal"
    ...
    override val VM_EXPORT_ZIPPING = "In ZIP-Archiv packen..."
    override fun vmExportError(msg: String) = "Fehler beim Export: $msg"
    override val VM_IMPORT_OPEN_ERROR = "Datei konnte nicht geöffnet werden"
    override val VM_IMPORT_DUPLICATE_WARNING = "Mögliches Duplikat erkannt (gleiches Startdatum und Dauer)."
    override val VM_IMPORT_DUPLICATE_WARNING_DESC = "Möchtest du trotzdem fortfahren?"
    override val VM_IMPORT_SUCCESS = "Training erfolgreich importiert."
    override fun vmImportError(msg: String) = "Importfehler: $msg"

    // Gpx Importer
    override val GPX_NO_POINTS = "GPX-Datei enthält keine Wegpunkte."
    override val GPX_WARN_HR = "Datei enthält Pulsdaten, aber die gewählte Aktivität unterstützt diese nicht."
    ...
    override val WIDGET_ASCENT = "Gesamtaufstieg"
    override val WIDGET_DESCENT = "Gesamtabstieg"
    override val WIDGET_STEPS = "Schritte"
    override val WIDGET_AVG_BPM = "Durchschn. Puls"
    ...
    override val WIDGET_MAX_ELEVATION_GAIN = "Höchster Höhengewinn"
    override val WIDGET_MAX_DISTANCE = "Größte Distanz"
    override val WIDGET_MAX_DURATION = "Längste Zeit"
    ...
    override val WIDGET_AVG_STEP_LENGTH = "Berechnete Schrittlänge"
    override val WIDGET_AVG_CADENCE_DESC = "Durchschn. Trittfrequenz"
    override val WIDGET_MAX_CADENCE = "Max. Trittfrequenz"
    override val WIDGET_TOTAL_STEPS = "Anzahl der Schritte"
    ...
    override val SENSOR_TOTAL_ASCENT = "Summe der Aufstiege"
    override val SENSOR_TOTAL_DESCENT = "Summe der Abstiege"
    ...
    // Trim Screen
    override val TRIM_TITLE = "Training bearbeiten (Zuschneiden)"
    override val TRIM_CONFIRM_TITLE = "Zuschneiden bestätigen"
    override val TRIM_CONFIRM_DESC = "Möchtest du die Daten außerhalb des gewählten Bereichs wirklich löschen? Diese Daten werden dauerhaft entfernt."
    override val TRIM_SAVE_BTN = "Zuschneiden und Speichern"
    override val TRIM_CHART_HR = "Puls-Diagramm"
    override val TRIM_RANGE_TITLE = "Trainingsbereich wählen"
    override val TRIM_PREVIEW_TITLE = "Vorschau neuer Statistiken"
    ...
    override val TRIM_AVG_BPM = "Durchschn. Puls:"
    ...
    // Strava Strings
    override val STRAVA_TITLE = "Synchronisation mit Strava"
    ...
    override val STRAVA_SYNC_SUCCESS = "Training wurde gesendet!"
    override val STRAVA_SYNC_FAILED = "Fehler beim Senden"
    override val STRAVA_SYNCING = "Wird gesendet..."
    override val STRAVA_AUTH_ERROR = "Autorisierungsfehler"
    override val SETTINGS_STRAVA_AUTO_EXPORT = "Automatischer Export"
    override val SETTINGS_STRAVA_AUTO_EXPORT_DESC = "Neue Trainings automatisch an Strava senden"
    override val STRAVA_SYNC_LOG = "Synchronisationsverlauf"
    override val STRAVA_SYNC_LOG_EMPTY = "Kein Synchronisationsverlauf vorhanden"

    // Live Tracking
    override val LIVE_TRACKING_TITLE = "Live-Tracking"
    override val LIVE_TRACKING_SELECT_ACTIVITY = "Aktivität wählen"
    override val LIVE_TRACKING_LOCK = "Sperren"
    override val LIVE_TRACKING_UNLOCK_SWIPE = "Zum Entsperren nach oben wischen"
    override val LIVE_TRACKING_MAP_NORTH = "Norden"
    override val LIVE_TRACKING_MAP_DIRECTION = "Richtung"
    override val LIVE_TRACKING_WAITING_FOR_WATCH = "Warte auf Signal von der Uhr..."
    override val LIVE_TRACKING_FINISHED_TITLE = "Aktivität beendet"
    override val LIVE_TRACKING_FINISHED_DESC = "Aktivität erfolgreich beendet"
    override val LIVE_TRACKING_BTN_FINISH = "Beenden"
    override val LIVE_TRACKING_BTN_VIEW_MAP = "Karte ansehen"
    ...
    // Support System
    override val SUPPORT_TITLE = "Autor unterstützen"
    override val SUPPORT_DISCLAIMER = "Alle App-Funktionen sind kostenlos. Die Wahl der Stufe ist eine freiwillige Unterstützung des Autors. Das Ändern des Symbols ist der einzige digitale Vorteil."
    override val SUPPORT_LIFETIME_BUY = "Lebenslang"
    override val SUPPORT_MONTHLY_SUB = "Monatlich"
    override val SUPPORT_ICON_CHANGE_NOTICE = "Das Ändern des Symbols kann einige Sekunden dauern oder einen Neustart des Launchers erfordern."
}