...
object TextsMobileES : MobileTexts {
    ...
    override val SETTINGS_DEFINITIONS = "Definicioni de actividad"
    ...
    override val HR_EFFECT_Z3 = "Melhora da capacidad aeróbica"
    ...
    override val COMPARE_LOWER_IS_BETTER = "Un risultato menor es mejor"
    ...
    override fun vmExportError(msg: String) = "Erro durante a exportación: $msg"
    override val VM_IMPORT_OPEN_ERROR = "Não é possível abrir o arquivo"
    override val VM_IMPORT_DUPLICATE_WARNING = "Detectado possível duplicata (mesmo horário de início e duración)."
    ...
    override val GPX_WARN_HR = "O arquivo contém danych de FC, mas a actividad seleccionada não os suporta."
    override val GPX_WARN_ELE = "O arquivo contém danych de altitude, mas a actividad seleccionada não os suporta."
    override val GPX_WARN_CADENCE = "O arquivo contém danych de cadência, mas a actividad seleccionada não os suporta."
    ...
    override val WIDGET_TOTAL_DESCENT = "Suma de descidas"
    ...
    override val TRIM_CONFIRM_DESC = "¿Está seguro de que desea eliminar los datos fuera del intervalo seleccionado? Estos datos se eliminarán permanentemente."
