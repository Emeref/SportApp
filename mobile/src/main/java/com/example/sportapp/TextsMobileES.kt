...
object TextsMobileES : MobileTexts {
    ...
    override val HOME_ACTIVE_WORKOUT = "Entrenamiento en curso"
    override val HOME_RESUME_TRACKING = "Reanudar seguimiento"
    ...
    override val DETAIL_TRAINING_EFFECT = "Efecto de entrenamiento"
    override val DETAIL_TRAINING_EFFECT_DESC = "Efecto de entrenamiento predominante"
    ...
    override val DETAIL_PREDOMINANT_EFFECT = "Efecto de entrenamiento predominante"
    ...
    override val DEF_LIST_TITLE = "Definiciones de actividad"
    ...
    override val DEF_AUTO_LAP_LABEL = "Vuelta automática (metros, opcjonalnie)"
    ...
    override val VM_IMPORT_DUPLICATE_WARNING = "Detectado posible duplicado (mismo horario de inicio y duración)."
    ...
    override val GPX_WARN_HR = "El archivo contiene datos de FC, pero la actividad seleccionada no los soporta."
    override val GPX_WARN_ELE = "El archivo contiene datos de altitud, pero la actividad seleccionada no los soporta."
    override val GPX_WARN_CADENCE = "El archivo contiene datos de cadencia, pero la actividad seleccionada no los soporta."
    ...
    override val WIDGET_MAX_DURATION = "Duración máxima"
    ...
    override val WIDGET_TOTAL_ASCENT = "Suma de subidas"
    override val WIDGET_TOTAL_DESCENT = "Suma de bajadas"
    ...
    // Trim Screen
    override val TRIM_TITLE = "Editar entrenamiento (Recorte)"
    ...
    override val TRIM_CHART_HR = "Gráfico de frecuencia cardíaca"
    override val TRIM_RANGE_TITLE = "Seleccionar rango de entrenamiento"
    override val TRIM_PREVIEW_TITLE = "Vista previa de las nuevas estadísticas"
    ...
    override val STRAVA_CONNECT = "Conectar con cuenta de Strava"
    override val STRAVA_DISCONNECT = "Desconectar Strava"
    ...
    override val LIVE_TRACKING_SELECT_ACTIVITY = "Seleccionar actividad"
    ...
    override val LIVE_TRACKING_FINISHED_DESC = "La actividad fue registrada con éxito."
    ...
    override val ERROR_NO_WATCH_CONNECTED = "No hay ningún reloj conectado"
