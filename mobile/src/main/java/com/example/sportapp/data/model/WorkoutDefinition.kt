...
enum class WorkoutSensor(val id: String, val getLabel: (MobileTexts) -> String) {
    ...
    fun label(texts: MobileTexts): String = getLabel(texts)

    @Deprecated("Use label(texts)", ReplaceWith("label(texts)"))
    val label: String
