...
object TextsMobilePT : MobileTexts {
    ...
    override val SETTINGS_WIDGETS_WATCH_DESC = "Selecionar e definir la ordem no relógio"
    ...
    override val DETAIL_LAP_MAX_SPEED = "Velocidade máxima"
    ...
    override fun chartDistanceGps(km: Boolean) = if (km) "Distância (GPS) em km" else "Distância (GPS) in m"
    override fun chartDistanceSteps(km: Boolean) = if (km) "Distância (passos) em km" else "Distância (passos) in m"
    ...
    override val DEF_HIKING = "Caminhada"
    ...
    override val HR_TOO_LITTLE_DATA = "Poucos dados"
    ...
    override val VM_EXPORT_ZIPPING = "Compactando em ZIP..."
    ...
    override val VM_IMPORT_DUPLICATE_WARNING_DESC = "Deseja continuar de qualquer maneira?"
    ...
    override val WIDGET_TOTAL_ASCENT = "Soma das subidas"
    override val WIDGET_TOTAL_DESCENT = "Suma das descidas"
    ...
    override val WIDGET_WATCH_ASCENT = "Subida total"
    override val WIDGET_WATCH_DESCENT = "Descida total"
    ...
    override val TRIM_PREVIEW_TITLE = "Prévia das novas estatísticas"
