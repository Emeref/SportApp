...
import com.example.sportapp.core.i18n.*
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val appStrings = when (settingsState.appLanguage) {
                    ...
                    Scaffold(
                        ...
                        SwipeDismissableNavHost(
                            ...
                            composable("language_selection") {
                                LanguageSelectionScreen(settingsState.appLanguage) { language ->
                                    scope.launch { settingsManager.saveAppLanguage(language) }
